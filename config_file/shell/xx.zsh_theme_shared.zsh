[[ -n "${XX_ZSH_THEME_SHARED_LOADED-}" ]] && return
typeset -g XX_ZSH_THEME_SHARED_LOADED=1
...
ZSH_HIGHLIGHT_STYLES[arg0]='fg=#81a1c1'
ZSH_HIGHLIGHT_STYLES[autodirectory]='fg=#81a1c1,underline'
