...
main() {
	...
	replace_symbols_link "$HOME/.config/nvim/lua/lazy.lua" "$SH_FOOT/config_file/nvim/lua/lazy.lua"
	replace_symbols_link "$HOME/.config/nvim/lua/plugins.lua" "$SH_FOOT/config_file/nvim/lua/plugins.lua"
	...
	for file in snippets/*.snippets; do
		...
		#replace_symbols_link "$HOME/.local/share/nvim/lazy/vim-snippets/UltiSnips/$file_name" "$SH_FOOT/config_file/$file"
	done
}
